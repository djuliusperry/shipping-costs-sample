...
def makeWebhookResult(req):
    ...
    speech = "Thank you for that information Mr. " + str(name[sin]) + ". Your bill amount for the month of " + billmonth + " is "  + str(amount[sin]) + " pesos. Do you want me to do an analysis on your bill?"
